...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [2] = LAYOUT_split_3x6_3( KC_NO, KC_NO, KC_EXLM, KC_DQUO, KC_DLR, KC_PERC,                      KC_SLSH, KC_TILD, KC_NO, KC_NO, KC_NO, KC_BSPC, 
                              KC_NO, KC_NO, KC_LCBR, KC_LBRC, KC_LPRN, KC_MINS,                     KC_COMM, KC_RPRN, KC_RBRC, KC_RCBR, KC_NO, KC_NO, 
                              KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_UNDS,                           KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, 
    ...
    [3] = LAYOUT_split_3x6_3(LALT(KC_TAB), KC_NO, KC_NO, KC_UP, KC_NO, KC_NO,                                   KC_NO, KC_NO, KC_VOLU, KC_VOLD, KC_MUTE, KC_BSPC, 
                                  ...
                                  KC_NO, LCTL(KC_Y), LCTL(KC_X), LCTL(KC_C), LCTL(KC_V), LCTL(KC_Z),            KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, 
                                                    TO(0), KC_LSFT, KC_NO,                               KC_ENT, KC_SPC, KC_NO),
