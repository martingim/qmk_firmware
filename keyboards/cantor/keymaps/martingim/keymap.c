...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [0] = LAYOUT_split_3x6_3( KC_ESC, KC_Q, KC_W, KC_E, KC_R, KC_T,                   KC_Y, KC_U, KC_I, KC_O, KC_P, KC_BSPC, 
                              ...
                              KC_LCTL, KC_Z, KC_X, KC_C, KC_V, KC_B,                  KC_N, KC_M, KC_COMM, KC_DOT, KC_SLSH, TO(4), 
                                                    TO(1), KC_LSFT, KC_LALT,   LT(2,KC_ENT), LT(3,KC_SPC), LT(1,KC_DEL)),
    ...
    [2] = LAYOUT_split_3x6_3( KC_NO, KC_NO, KC_EXLM, KC_DQUO, KC_DLR, KC_PERC,                      KC_BSLS, KC_TILD, KC_NO, KC_NO, KC_NO, KC_BSPC, 
